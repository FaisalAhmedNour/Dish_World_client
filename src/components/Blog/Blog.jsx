        ...
        <div className='w-full mt-6'>
            ...
            <div className='w-3/4 mx-auto space-y-4'>
                ...
                <div ref={ref} className='bg-lightbg p-14 rounded-md shadow-lg relative'>
                    ...
                    <h3 className=''><span className="text-underline text-semibold">Ans:</span>A custom hook in React is a reusable function that encapsulates a specific behavior or logic to be shared across multiple components. It allows you to extract and reuse stateful logic in a concise and modular way. You would create a custom hook to promote code reusability, reduce duplication, and separate concerns by abstracting away complex logic into a reusable function, making your components cleaner and more maintainable.</h3>
                    <Pdf targetRef={ref} filename="code-example.pdf">
                        {({ toPdf }) => <button className='btn btn-primary btn-sm absolute bottom-4 left-14 mt-5' onClick={toPdf}>Download as Pdf</button>}
                    </Pdf>
                </div>
